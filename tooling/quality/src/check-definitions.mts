    ...
    requirements: [
      ...
      },
      {
        ...
        includes: [
          ...
          "maestro-brain-staging",
          "maestro-brain-production",
        ...
        absent: ["sharedConvexBackendNote"],
        message:
          "project config must declare isolated deploy environments, Convex URLs, deploy-key env names, and callback origins without a shared-backend exception",
      },
      {
        ...
        includes: [
          ...
          "buildkite-agent meta-data set staged-release-packet",
          "pages deploy apps/web/dist/client",
          "buildkite-agent meta-data set staged-sha",
        ],
        absent: ["demo/showcase:seed"],
        message:
          "staging deploy must doctor isolated credentials, deploy backend first, bake the Convex URL, emit a signed release packet, and never seed demo data",
      },
      {
        ...
        includes: [
          ...
          "promote-plan",
          "buildkite-agent meta-data get staged-sha",
          "buildkite-agent meta-data get staged-release-packet",
        ...
        absent: ["demo/showcase:seed"],
        message:
          "production promote must require the staged release packet, deploy backend first, bake the production Convex URL, and never seed demo data",
      },
    ],
  },
  deps: {
