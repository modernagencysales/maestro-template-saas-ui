...
export const CURRENT_EMAIL_CLOSURE = [
  ...
  "docs/template/app-idea-funnel-operations.md",
  "docs/template/client-handoff-packet.md",
  "docs/template/client-intake-wizard.md",
  "docs/template/extraction/dependency-license-inventory.md",
  "docs/template/extraction/provider-provisioning-inventory.md",
  ...
  "packages/app-idea-evaluator/src/maestroMapping.test.ts",
