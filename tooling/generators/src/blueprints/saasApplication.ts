  ...
  const replacements = new Map<string, "copy" | "generate">([
    ...(current
      ? ([
          ...
          ["product.contract.yaml", "copy"],
          ["product.contract.schema.json", "copy"],
          ["docs/template/generated/product-contract.md", "copy"],
          ["playwright.acceptance.config.ts", "copy"],
          ...
          ["docs/product/records-plan.md", "copy"],
          ["tests/acceptance/records.spec.ts", "copy"],
          ["tests/acceptance/support/fixtures.ts", "copy"],
          ["tests/acceptance/support/runtime.ts", "copy"],
