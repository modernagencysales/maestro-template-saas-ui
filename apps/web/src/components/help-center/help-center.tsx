...
export interface HelpCenterDialogProps extends Omit<
  Drawer.RootProps,
  "children"
> {
...
> = (props) => {
  const { icon, title, description, href = "#", target, ...rest } = props;
  return (
    <LinkBox asChild>
      <Card.Root
        {...rest}
      ...
      >
        <Card.Body py="2" display="flex" flexDirection="row" gap="3">
