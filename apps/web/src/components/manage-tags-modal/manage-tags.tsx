...
const TagListItem: React.FC<TagListItemProps> = (props) => {
  ...
  return edit ? (
    <GridList.Item role="group" py="1" bg="bg.subtle" borderRadius="md" gap="2">
      <GridList.Cell px="0">
        <ColorControl
          value={color}
          colors={colors}
      ...
      <GridList.Cell display="flex" gap="2">
        ...
        <Button size="sm" loading={isLoading} onClick={() => onSave()}>
          Save
        </Button>
      </GridList.Cell>
    </GridList.Item>
  ) : (
    <GridList.Item role="group" py="1" borderRadius="md" mb="1.5" gap="2">
      <GridList.Cell px="0">
        <Flex
...
const TagListAddItem: React.FC<TagListAddItemProps> = (props) => {
  ...
  return (
    <Collapsible.Root open={openState.open}>
      <Collapsible.Content>
        <HStack role="group" py="2" px="2" borderWidth="1px" borderRadius="md">
          <Box>
            <ColorControl
              value={values.color}
              colors={colors ?? []}
