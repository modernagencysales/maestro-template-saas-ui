# ManageEvaluationReport Capability

Generated manageEvaluationReport capability. Replace the domain logic while
preserving the contract shape.
...
3. Add generated refs to the web/API/CLI/MCP surfaces selected in
   `manageEvaluationReport.headless.json`.
