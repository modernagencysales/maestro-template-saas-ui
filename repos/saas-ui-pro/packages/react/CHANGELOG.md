...
- Upgrade Chakra UI
- Updated dependencies [680771c]
  - @saas-ui-pro/onboarding@1.0.0-next.1

## 1.0.0-next.4

### Patch Changes

- dd7327d: Use new Saas UI Chakra preset package

## 1.0.0-next.3

### Patch Changes

- Fixed datagrid line height

## 1.0.0-next.2

### Minor Changes

- 525c42b: Moved Page, Section, useSearchQuery to @saas-ui/react

### Patch Changes

- 736b0f4: Removed bg from split page content recipe
...
- 4a8539d: Upgrade to Chakra UI v3

### Minor Changes

- 9927084: Removed ErrorPage component

### Patch Changes

- 8b3f28c: Removed BackButton icon prop, use children instead
- 8b3f28c: Improved PageHeader composition and recipe
- f5794c7: Fixed css selectors in DataGrid recipe
- 0ae9177: Bump version
- 7676f41: Upstream fixes
- Updated dependencies [4a8539d]
  - @saas-ui-pro/onboarding@1.0.0-next.0
