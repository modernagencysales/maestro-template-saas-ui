...
export const WORKFLOW_SEMANTICS = [
  ...
  restricted(
    ...
    "WP-1.1 accepts the discriminant while executable V2 node compilation remains disabled.",
    "Use the source-to-output starter graph until the WP-1.2 exact step compiler lands.",
    V2_GRAPH_FIXTURE,
  ),
  restricted(
    "WF-NODE-SCHEDULE",
